    ...
    <div className="space-y-4 animate-fade-in-up">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div className="lg:col-span-4 flex flex-col gap-4">
          ...
          <Card className="flex-1 p-6 bg-primary/5 border-2 border-primary/20 hover:border-primary/40 transition-all duration-300 hover:shadow-lg">
        ...
        <Card className="lg:col-span-12 p-6 bg-amber-500/10 border-2 border-amber-500/30 hover:shadow-lg transition-all duration-300">
